...
const REACTION_PRESETS: ReactionPreset[] = [
  ...
  },
  {
    ...
    emoji: "🌅",
    label: "Ngày mai nhẹ hơn",
    glowClass: "reaction-heart",
    glowColor: "rgba(255, 138, 80, 0.3)",
  },
  {
    key: "brave",
    emoji: "⭐",
    label: "Bạn rất can đảm",
    glowClass: "reaction-star",
    glowColor: "rgba(124, 158, 255, 0.3)",
  },
  {
    key: "im-here",
    emoji: "💙",
    label: "Có mình ở đây",
    glowClass: "reaction-heart",
    glowColor: "rgba(100, 160, 255, 0.3)",
  },
  {
    key: "shining-star",
    emoji: "✨",
    label: "Trao ngôi sao sáng",
    glowClass: "reaction-candle",
    glowColor: "rgba(245, 214, 125, 0.35)",
  },
];
